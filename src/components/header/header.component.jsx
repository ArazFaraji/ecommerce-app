...
// const mapStateToProps = state => ({     in the below line we take this existing line, destructure it with nested values. Such as 'currentUser' is being destructured from 'user' which is being destructed from state. 
